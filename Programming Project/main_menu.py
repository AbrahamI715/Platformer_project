...
class MainMenuState:
    ...
    def start(self):
        self.time_to_switch = False
        self.new_game_button = pygame_gui.elements.UIButton(pygame.Rect(400, 200, 150, 30),
                                                            "New Game",
                                                            self.ui_manager)
        self.options_button = pygame_gui.elements.UIButton(pygame.Rect(400, 250, 150, 30),
                                                           "Options",
                                                           self.ui_manager)
        self.quit_button = pygame_gui.elements.UIButton(pygame.Rect(400, 300, 150, 30),
                                                        "Quit",
                                                        self.ui_manager)
